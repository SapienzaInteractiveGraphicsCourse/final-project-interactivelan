import{J as e,M as t,V as n,q as r}from"./loader-BEPwMxRc.js";var i=new r;function a(e){let t=i.load(e);return t.flipY=!1,t}function o(e,n=-1,r=-1){let i=`/final-project-interactivelan/textures/${e}`,o=new t({map:a(`${i}/Base.png`),normalMap:a(`${i}/Normal_OpenGL.png`),aoMap:a(`${i}/AO.png`)});return n===-1?o.metalnessMap=a(`${i}/Metallic.png`):o.metalness=n,r===-1?o.roughnessMap=a(`${i}/Roughness.png`):o.roughness=r,o}var s=o(`launcher`),c=o(`tank`),l=o(`terrain`,0,.92);l.map.repeat.set(50,50),l.map.wrapS=n,l.map.wrapT=n,l.normalMap.repeat.set(50,50),l.normalMap.wrapS=n,l.normalMap.wrapT=n,l.aoMap.repeat.set(50,50),l.aoMap.wrapS=n,l.aoMap.wrapT=n,l.normalScale=new e(1.4,1.4),l.vertexColors=!0;var u=class{constructor(){this.waveCounterElement=null,this.stateElement=null,this.crosshairElement=null,this.buildWaveCounter(),this.buildScore(),this.buildStateIndicator(),this.initCrosshair()}async initCrosshair(){try{let e=await(await fetch(`/final-project-interactivelan/ui/crosshair.svg`)).text();this.crosshairElement=document.createElement(`div`),this.crosshairElement.id=`crosshair-ui`,this.crosshairElement.style.cssText=`
                position: fixed;
                top: 0; left: 0;
