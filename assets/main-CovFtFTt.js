import{F as e,J as t,R as n,S as r,U as i,W as a,X as o,_ as s,a as c,c as l,i as u,l as d,m as f,n as p,o as m,r as h,s as g,t as _,u as ee,v,y}from"./loader-CbkMRmj5.js";import{t as te}from"./menu_bg-TV5dXsb4.js";import{i as ne,n as b,t as x}from"./tank-Ce-erd6u.js";import{t as S}from"./launcher-CibhKtPX.js";import{t as C}from"./hud-kVpjlWDM.js";import{i as re,n as w,r as ie,t as ae}from"./grass-DC_Cr9L6.js";import{n as oe,t as T}from"./tv-B6dKYC9P.js";var E=class{constructor(e){this.listener=new l,e.add(this.listener),this.loader=new d,this.buffers={}}setCamera(e){!e||this.listener.parent===e||e.add(this.listener)}async load(e,t){let n=await(await fetch(t)).arrayBuffer();new TextDecoder().decode(n.slice(0,120));let r=await this.listener.context.decodeAudioData(n);return this.buffers[e]=r,r}createPositional(e,{loop:t=!1,volume:r=1,refDistance:i=20,rolloffFactor:a=1,distanceModel:o=`inverse`,maxDistance:s=200}={}){let c=this.buffers[e];if(!c)return console.warn(`Audio buffer "${e}" was not loaded`),null;let l=new n(this.listener);return l.setBuffer(c),l.setLoop(t),l.setVolume(r),l.setRefDistance(i),l.setRolloffFactor(a),l.setDistanceModel(o),l.setMaxDistance(s),l}};async function se(e){for(let[t,n]of[[`launcherFire`,`/final-project-interactivelan/sounds/missile_firing.ogg`],[`launcherReload`,`/final-project-interactivelan/sounds/reload.ogg`],[`tubeToss`,`/final-project-interactivelan/sounds/reload.ogg`],[`tubeDrop`,`/final-project-interactivelan/sounds/drop.ogg`],[`reloadClick`,`/final-project-interactivelan/sounds/click.ogg`],[`missileExplosion`,`/final-project-interactivelan/sounds/explosion_a.ogg`],[`tankExplosion`,`/final-project-interactivelan/sounds/explosion_b.ogg`],[`tankEngine`,`/final-project-interactivelan/sounds/tank_moving.ogg`],[`tankTrack`,`/final-project-interactivelan/sounds/tracks.ogg`],[`tankTurretRotate`,`/final-project-interactivelan/sounds/turret_rotate.ogg`]])try{await e.load(t,n),console.log(`Loaded sound: ${t}`,n)}catch(e){throw console.error(`Failed loading sound: ${t}`,n,e),e}}async function D(e,t,n){let i=new oe(1),c=new T,l=new a;l.background=new f(657930),await c.load(l,new o(0,0,0),`/final-project-interactivelan/models/tv.glb`);let u=new ee().setFromObject(c.model),d=new o,p=new o;u.getCenter(d),u.getSize(p);let m=Math.max(p.x,p.y,p.z);t.position.set(d.x,d.y+.2,d.z+m*1.3),t.lookAt(d);let h=new r(12572927,1710618,.55);l.add(h);let g=new s(16774112,.09);g.position.set(1,3,10),l.add(g),e.setAnimationLoop(()=>{e.render(l,t)});let _=document.createElement(`div`);_.style.cssText=`
        position: fixed;
        bottom: 20px;
        right: 24px;
